...
const passwordSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.PASSWORD_LENGTH_MUST_BE_FORM_6_TO_50
  },
  isStrongPassword: {
    options: {
      minLength: 6,
...
const confirmPasswordSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.CONFIRM_PASSWORD_LENGTH_MUST_BE_FORM_6_TO_50
  },
  isStrongPassword: {
    options: {
      minLength: 6,
...
const nameSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.NAME_LENGTH_MUST_BE_FORM_1_TO_100
  },
  trim: true
}
...
const imageSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.IMAGE_LENGTH_MUST_BE_FORM_1_TO_200
  }
}
          ...
          options: async (value: string, { req }) => {
            ...
            try {
              const [decoded_refresh_token, refresh_token] = await Promise.all([
                await verifyToken({ token: value, secretOrPublicKey: envConfig.jwtSecretRefreshToken as string }),
  ...
  checkSchema(
    {
      ...
      bio: {
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.BIO_LENGTH_MUST_BE_FORM_1_TO_200
        }
      },
      location: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.LOCATION_LENGTH_MUST_BE_FORM_1_TO_200
        },
        trim: true
      },
      website: {
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.WEBSITE_LENGTH_MUST_BE_FORM_1_TO_200
        }
      },
      username: {
        optional: true,
